    ...
    return (
        <Layout>
            <div className="flex justify-between">
                <p id="Profile" onClick={() => location.replace("/profile?category=Profile")} className="cursor-pointer text-center w-1/2 px-auto py-5 border-gray-100 border-2">
                    Perfil
                </p>
                <p id="Orders" onClick={() => location.replace("/profile?category=Orders")} className="cursor-pointer text-center w-1/2 px-auto py-5 border-gray-100 border-2">
                    Órdenes
                </p>
            </div>
            {
